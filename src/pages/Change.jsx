...
import { ResetFields } from "../utils/input";
...
export default function Change(){
    ...
    const handleSubmit = async (e) => {
      ...
      dispatch(resetPassword(formData.password,formData.confirmPassword,params.token,navigate));
      setFormData({
          password: "",
          confirmPassword:"",
        })
   ...
   <div className="flex -mx-3">
    ...
    <button type='submit'   className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Submit</button>
     </div>
      </div>
     </form>
     </div>
